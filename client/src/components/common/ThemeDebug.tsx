  ...
  return (
    <div className="fixed bottom-4 right-4 bg-white dark:bg-neutral-800 border-2 border-accent p-4 rounded-lg shadow-lg z-50">
      ...
      <div className="text-sm">
        <p className="text-neutral-900 dark:text-white">Current theme: <strong>{theme}</strong></p>
        <p className="text-neutral-900 dark:text-white">Is dark: <strong>{isDark ? 'Yes' : 'No'}</strong></p>
        <p className="text-neutral-900 dark:text-white">HTML class: <strong>{document.documentElement.className}</strong></p>
      </div>
