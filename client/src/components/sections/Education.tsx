      ...
      <div className="animate-fade-up animation-delay-600">
        ...
        <div className="space-y-6 max-w-full">
          {education.map((edu) => (
            <div
              key={edu.id}
              className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10 hover:border-wave-primary/30 transition-all duration-300"
            >
              ...
              {edu.achievements && edu.achievements.length > 0 && (
                <ul className="space-y-1 text-sm text-neutral-300 mt-6">
